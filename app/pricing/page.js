    ...
    <>
      ...
      <div className="min-h-screen bg-white pt-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-20">
          {/* Plan Gratuit */}
          <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:scale-105 hover:shadow-lg transition-all">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold mb-2 text-gray-900">Gratuit</h2>
              <div className="text-5xl font-bold mb-4 text-gray-900">
                0€
                <span className="text-xl text-gray-600">/mois</span>
              </div>
              <p className="text-gray-600">Parfait pour découvrir FripeScan</p>
            </div>

            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                <svg className="w-6 h-6 text-[#2558A5] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="block w-full text-center px-8 py-4 bg-gray-900 text-white rounded-2xl font-bold text-lg hover:bg-[#2558A5] hover:shadow-xl hover:scale-105 transition-all"
            >
          ...
          {/* Plan Premium */}
          <div className="bg-[#2558A5] rounded-3xl p-8 hover:scale-105 transition-transform relative overflow-hidden shadow-xl">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full text-center px-8 py-4 bg-white text-[#2558A5] rounded-2xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all"
            >
              Passer à Premium
            </a>
          </div>
        ...
        <section className="max-w-4xl mx-auto mb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#F7F7F7] dark:bg-zinc-900 rounded-2xl p-6">
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
                Mes données sont-elles sécurisées ?
              </h3>
              <p className="text-gray-600">
                Absolument. Nous utilisons un chiffrement de bout en bout et sommes conformes au RGPD. Vos photos ne sont utilisées que pour l'analyse et ne sont jamais partagées avec des tiers. Consultez notre <a href="/legal/privacy" className="text-[#3498DB] hover:text-[#3498DB] underline">politique de confidentialité</a>.
              </p>
            </div>
