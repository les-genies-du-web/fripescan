      ...
      <div className="min-h-screen bg-white pt-20 py-12 px-4">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">1. Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">2. Données collectées</h2>
            <h3 className="text-xl font-semibold mb-3 text-gray-900">2.1 Données d'inscription</h3>
            ...
            <h3 className="text-xl font-semibold mb-3 text-gray-900">2.2 Données d'utilisation</h3>
            <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">3. Utilisation des données</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">4. Base légale du traitement</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">5. Partage des données</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">6. Conservation des données</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">7. Vos droits (RGPD)</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">8. Sécurité des données</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">9. Cookies et technologies similaires</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">10. Transferts internationaux</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">11. Mineurs</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">12. Modifications de la politique</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-[#2558A5] text-2xl font-bold mb-4">13. Contact et réclamations</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
