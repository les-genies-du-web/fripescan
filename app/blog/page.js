      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <nav className="flex justify-between items-center mb-12">
          ...
          <div className="flex gap-4">
            <a href="/pricing" className="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-[#215B87] dark:hover:text-[#e18343] transition-colors">
              Tarifs
            </a>
            <a href="/blog" className="px-4 py-2 text-[#215B87] dark:text-[#e18343] font-semibold">
              Blog
            </a>
          </div>
        </nav>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {articles.map((article) => (
            <a
              ...
              className="group bg-[#F5F5F7] dark:bg-zinc-800 rounded-3xl overflow-hidden hover:scale-105 transition-transform"
            >
              <div className="aspect-video bg-gradient-to-br from-[#215B87] to-[#e18343] flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <h2 className="text-xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-[#215B87] dark:group-hover:text-[#e18343] transition-colors">
                  {article.title}
                </h2>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[#215B87] dark:text-[#e18343] font-semibold group-hover:translate-x-1 transition-transform">
                    Lire →
                  </span>
                </div>
              </div>
